...
○	java.lang.Math 클래스는
	...
	생성자가 있긴 하지만... 『private』로 선언되어 있기 때문에
	외부에서 객체(인스턴스)를 생성할 수 없다.
	단, 모든 메소드가 『static』으로 정의되어 있기 때문에
...
○	java.lang.Math 클래스의 주요 상수 및 메소드
	...
	- public static double tan(double a)
	  : sin(a), cos(a), tan(a) 값을 반환함 (삼각함수)

	- public static double asin(double a)
	- public static double acos(double a)
	- public static double atan(double a)
	  : asin(a), acos(a), atan(a) 값을 반환함 (삼각함수의 역함수)

    - public static double toRadians(double angdeg)
	  : 각도(angdeg)를 라디안(radian)으로 바꾸어 변환한다.
    - public static double toDegrees(double angrad)
	  :라디안(radian)을 각도(angdeg)로 바꾸어 변환한다.
	...
	- public static double ceil(double a)
	 : a 보다 크거나 같은 정수를 반환한다. (올림)

	- public static double floor(double a)
	 : a 보다 작거나 같은 정수를 반환한다. (절삭)
...
public class Test147
{
	public static void main(String[] args)
	{
		...
		// 0.0~1.0 사이의 난수 : 0.05880778616919813
		// 0.0~1.0 사이의 난수 : 0.9170548598988414
		// 0.0~1.0 사이의 난수 : 0.45082778504022614
		// 0.0~1.0 사이의 난수 : 0.20254360285343753
		// 0.0~1.0 사이의 난수 : 0.06089708186007314
	}
}