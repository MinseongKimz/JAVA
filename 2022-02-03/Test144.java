...
○	Calendar 클래스 객체(인스턴스)를 생성할 수 있는 방법.
	...
	// GregorianCalendar()는 Calendar의 자식클래스, 업캐스팅
...
public class Test144
{
	public static void main(String[] args)
	{
		...
		int y = rightNow.get(Calendar.YEAR); //YEAR = 파이널 스태틱 변수 
		System.out.println(y);
		//--==> 2022

		int m = rightNow.get(Calendar.MONTH)+1; 
		// 월 은 배열 형태로 INDEX 형태로 저장.. 『+1』해주자..
		...
		rightNow2.set(2022,5,20); // 월은 인덱스로 저장... 넣을땐 『-1』 해주자
								  // 수료날짜 2022-6-20일..
