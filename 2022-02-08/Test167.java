...
public class Test167
{
	public static void main(String[] args)
	{
		...
		// list3에 list 의 전체 요소 추가 → addAll()
		list3.addAll(list2);

		// "스파이더맨" 앞에 "레미제라블" 추가
		// ① "스파이더맨" 찾ㄱ기 → indexOf() → 위치값 인덱스 반환
