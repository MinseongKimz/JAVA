...
○	HashMap<K, V> 클래스
	...
	- Hashtable클래스와 마찬가지로 Map 인터페이스에서 상속받은
...
public class Test173
{
	public static void main(String[] args) throws IOException
	{
		...
		Map<String, String> map = new HashMap<String, String>(); // 위와 같은 구문(업캐스팅)
		...
		//   최초 null을(문번호 48) key로 매핑하는 null을 덮어쓰는 상황이 발생하게 된다.
...
/*
{드라마=이태원클라스, 영화=스파이더맨, 만화=슬램덩크}
카테고리, 타이틀 입력(컴마 구분) : 소설, 죄와 벌
{null=생각하는사람, 소설=죄와 벌, 드라마=이태원클라스, 영화=스파이더맨, 만화=슬램덩크}
,안녕
{null=생각하는사람, 소설=죄와 벌, =안녕, 드라마=이태원클라스, 영화=스파이더맨, 만화=슬램덩크}
드라마,오징어게임
{null=생각하는사람, 소설=죄와 벌, =안녕, 드라마=오징어게임, 영화=스파이더맨, 만화=슬램덩크}
