...
※ 자바 컬렉션은 견고한 컬랙션 프레임워크 기반 위에 정의되어 있으므로
	...
	public static void main(String[] args)
	{
		...
		// peek() : 스택 맨 위의 객체 반환. 제거하지 않는다.
		 ...
		 /*
			...
			value : 최문정
			value : 홍은혜
			배열과 다른게 배열은 뭐 값을 꺼내든 말든 그 배열 자체가 바뀌지는 않지만
			스택은 맨윗걸 꺼내고 지워나가는 형태이여서 모든 데이터를 꺼냈다면
			그 스택안에는 아무것도 없을 것이다.
		 */
	}
}