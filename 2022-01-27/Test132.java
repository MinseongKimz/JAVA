...
○ Wrapper 클래스
	...
	2.	기본 자료형인
		...
		형 변환이 가능하고 동등 비교와 같은 연산자도 가능하다.
...
○	오토 박싱(Auto-Boxing) 과 오토 언박싱(Auto-Unboxing)
	...
	일반작어로 레퍼런스 형과 기본 자료형은 호환되지 않으며
	...
	Integer ob;
	ob = a;
	//-- 기본 자료형(int)이 Integer 형으로 자동 변환됨(오토 박싱)
	...
	이는 JDK 1.5 이후 추가된 오토박싱/ 오토 언박싱 이라는
	기능으로 인해 가능해 진 것이다.
...
public class Test132
{
	public static void main(String[] args)
	{
		...
		c = new Integer(0); // Integer 기반 인스턴스 생성
		// c = 0;

		//※ 레퍼런스형(참조타입)과 기본 자료형 (기본 타입)은 호환되지 않는다. 

		b = c; //--Integer형 데이터(객체) → int 형 변수 (오토 언박싱) 
		b = c.intValue(); // 그냥 언박싱.. 윗줄을 풀어서 쓴것.
		...
		d = new Double(12.345); // 업캐스팅   Double 객체에서 > Object 객체
		System.out.println("d.toString() : " + d.toString());
		//--==>> d.toString() : 12.345
