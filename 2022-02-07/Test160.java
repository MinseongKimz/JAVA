...
○	벡터 (Vector)
	...
	배열과 비슷하지만, 배열과 달리 다른 종류의 데이터 형을가진
	데이터 요소를 가질 수 있으며, 데이터가 가득차면 자동으로 저장 영역을
	확장시키게 된다.

	또한, 객체 래퍼런스를 저장하기 때문에
	...
	따라서, 자료구조의 양 끝단에서만 접근이 가능한 큐나 한쪽 끝에서만 접근 가능한 스택과 달리
	...
	- int indexOf(Object o, int index)
	  주어진 객체가 저장된 위치 index 위치부터 찾아서 반환한다.
